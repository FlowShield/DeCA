...
Thank you for your interest in FlowShield!
...
This document provides the guidelines for how to contribute to the FlowShield project.
...
1. Is it the right repository?
    - The FlowShield project is distributed across multiple repositories. Check the list of [repositories](https://github.com/FlowShield) if you aren't sure which repo is the correct one.
...
This section describes the guidelines for contributing code / docs to FlowShield.
...
The Developer Certificate of Origin (DCO) is a lightweight way for contributors to certify that they wrote or otherwise have the right to submit the code they are contributing to the project. Here is the full text of the [DCO](https://github.com/FlowShield/.github/blob/main/DCO.md), reformatted for readability:
```
